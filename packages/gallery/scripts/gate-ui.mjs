...
async function main() {
  ...
  try {
    ...
    // Skipped entirely when the crawl was unusable: the visual layer audits the
    // same gallery this run could not measure, so a "visual PASS" beside an
    // unusable runtime result is exactly the kind of confident-looking output
